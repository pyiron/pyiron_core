...
class TestDemoWorkflows(unittest.TestCase):
    ...
    def setUpClass(cls):
        cls.to_download = {
            "MgCaFreeEnergies.pckl.gz": "https://github.com/pyiron-workshop/DPG-tutorial-2025/raw/351eeca736cce45f9bc3bfca84ab05de049e38c2/data/MgCaFreeEnergies.pckl.gz"
        }
        for fname, url in cls.to_download.items():
