...
def create_nodes_table(db_url=f"postgresql://localhost/{username}", echo=False):
    """
    ...
    Parameters:
    db_url (str, optional): The database URL. Defaults to f'postgresql://localhost/{username}'.
